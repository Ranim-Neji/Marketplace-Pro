...
<div class="container-layout py-16">
    <div class="row justify-content-center">
        <div class="col-lg-10">
            <div class="d-flex align-items-center gap-6 mb-12 border-b border-border dark:border-border pb-10">
                <a href="{{ route('vendor.products.index') }}" class="h-10 w-10 flex items-center justify-center rounded-xl bg-muted dark:bg-dark border border-border dark:border-border text-muted-foreground hover:text-primary transition-all">
                    <i class="fa-solid fa-arrow-left"></i>
                </a>
                <div>
                    <h1 class="text-3xl font-black text-foreground dark:text-white uppercase tracking-tighter">Deploy Asset</h1>
                    <div class="text-[10px] font-black text-muted-foreground uppercase tracking-widest mt-2">New Entry into the Vault</div>
                </div>
            </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-12">
                    ...
                    <div class="lg:col-span-8 space-y-8">
                        ...
                        <div class="bg-white dark:bg-slate-950 rounded-[2rem] border border-slate-100 dark:border-slate-900 p-8 lg:p-10 shadow-sm">
                            ...
                            <div class="space-y-6">
                                <div>
                                    <label class="block text-[10px] font-black text-muted-foreground uppercase tracking-widest mb-3">Asset Title <span class="text-warning">*</span></label>
                                    <input type="text"
                                           name="title"
                                ...
                                <div>
                                    <label class="block text-[10px] font-black text-muted-foreground uppercase tracking-widest mb-3">Short Protocol Summary</label>
                                    <input type="text"
                                ...
                                <div>
                                    <label class="block text-[10px] font-black text-muted-foreground uppercase tracking-widest mb-3">Technical Description <span class="text-warning">*</span></label>
                        ...
                        <div class="bg-white dark:bg-slate-950 rounded-[2rem] border border-slate-100 dark:border-slate-900 p-8 lg:p-10 shadow-sm">
                            <h3 class="text-xs font-black text-slate-900 dark:text-white uppercase tracking-[0.2em] mb-8 flex items-center gap-3">
                                <i class="fa-solid fa-currency-dollar text-primary"></i> Liquidity & Volume
                            </h3>
                    ...
                    <div class="lg:col-span-4 space-y-8">
                        ...
                        <div class="bg-white dark:bg-slate-950 rounded-[2rem] border border-slate-100 dark:border-slate-900 p-8 shadow-sm">
                            <h3 class="text-xs font-black text-slate-900 dark:text-white uppercase tracking-[0.2em] mb-8 flex items-center gap-3">
                                <i class="fa-solid fa-image text-dark"></i> Visual Identity <span class="text-warning">*</span>
                            </h3>
                            
                            <div id="imagePreviewContainer"
                                 class="relative aspect-square rounded-2xl border-2 border-dashed border-slate-100 dark:border-slate-800 flex flex-col items-center justify-center bg-slate-50 dark:bg-dark/50 hover:bg-slate-100 dark:hover:bg-dark transition-all cursor-pointer group overflow-hidden"
                            ...
                            @error('image')
                                <div class="text-warning text-[10px] font-bold mt-4 uppercase tracking-tight">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="bg-white dark:bg-slate-950 rounded-[2rem] border border-slate-100 dark:border-slate-900 p-8 shadow-sm">
                            ...
                            <div class="space-y-4 max-h-72 overflow-y-auto pr-4 custom-scrollbar">
                                @error('categories')
                                    <div class="text-warning text-[10px] font-bold mb-4 uppercase tracking-tight">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="bg-white dark:bg-slate-950 rounded-[2rem] border border-slate-100 dark:border-slate-900 p-8 shadow-sm">
                            <label class="flex items-center justify-between cursor-pointer group">
                                <div class="flex items-center gap-3">
                                    <div class="h-8 w-8 rounded-lg bg-amber-50 dark:bg-accent/10 flex items-center justify-center text-accent">
