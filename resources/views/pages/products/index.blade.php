...
<div class="container-layout py-16">
    <div class="flex flex-col md:flex-row justify-between items-end gap-8 mb-12 border-b border-border dark:border-border pb-10">
        <div>
            <h1 class="text-3xl font-black text-foreground dark:text-white uppercase tracking-tighter">Product Inventory</h1>
            <div class="text-[10px] font-black text-muted-foreground uppercase tracking-widest mt-2">{{ $products->count() }} Products Registered</div>
        </div>
    ...
    @if($products->isEmpty())
        <div class="py-32 flex flex-col items-center justify-center bg-white dark:bg-dark rounded-[3rem] border border-border dark:border-border">
            <div class="h-24 w-24 bg-muted dark:bg-dark rounded-full flex items-center justify-center mb-10">
                <i class="fa-solid fa-box-open text-3xl text-border"></i>
            </div>
            <h2 class="text-xl font-black dark:text-white uppercase tracking-tighter mb-4">Inventory Empty</h2>
            <p class="text-xs text-muted-foreground mb-10 uppercase font-bold tracking-widest">No products are currently registered in your inventory</p>
                ...
                <div class="group bg-white dark:bg-slate-950 border border-slate-100 dark:border-slate-900 rounded-2xl p-6 sm:px-10 hover:border-primary transition-all">
                    <div class="grid grid-cols-1 sm:grid-cols-12 items-center gap-6">
                        ...
                        <div class="col-span-4 flex items-center gap-6">
                            <div class="h-16 w-16 rounded-xl overflow-hidden bg-slate-50 dark:bg-dark border border-slate-100 dark:border-slate-800 shrink-0">
                        ...
                        <div class="col-span-2">
                            <span class="inline-flex items-center gap-2 px-3 py-1 rounded-lg text-[9px] font-black uppercase tracking-widest bg-slate-50 dark:bg-dark text-slate-900 dark:text-white border border-slate-100 dark:border-slate-800">
                        ...
                        <div class="col-span-2 text-right">
                            ...
                            <div class="w-16 h-1 bg-slate-100 dark:bg-dark rounded-full mt-2 ml-auto overflow-hidden">
                        ...
                        <div class="col-span-2 flex justify-end gap-3">
                            <a href="{{ route('products.show', $product) }}" class="h-9 w-9 flex items-center justify-center rounded-lg bg-slate-50 dark:bg-dark border border-slate-100 dark:border-slate-800 text-slate-400 hover:text-primary hover:border-primary transition-all">
                                <i class="fa-solid fa-eye text-[10px]"></i>
                            </a>
                            <a href="{{ route('vendor.products.edit', $product) }}" class="h-9 w-9 flex items-center justify-center rounded-lg bg-slate-50 dark:bg-dark border border-slate-100 dark:border-slate-800 text-slate-400 hover:text-accent hover:border-accent transition-all">
