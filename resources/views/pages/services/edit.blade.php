    ...
    <div class="row justify-content-center">
        <div class="col-lg-10">
            <div class="flex items-center gap-6 mb-12 border-b border-slate-100 dark:border-slate-800 pb-10">
                ...
                <div>
                    <h1 class="text-3xl font-black text-slate-900 dark:text-white uppercase tracking-tighter">Edit Service</h1>
                    <div class="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-2">Refine your professional offering</div>
                </div>
            </div>
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <textarea name="description"
                                              ...
                                              placeholder="What does this service include? Be specific about deliverables...">{{ old('description', $service->description) }}</textarea>
                                    @error('description')
                                        <div class="text-warning text-[10px] font-bold mt-2 uppercase tracking-tight">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <select name="availability" class="input-premium">
                                        <option value="1" {{ old('availability', $service->availability) ? 'selected' : '' }}>Available Now</option>
                                        <option value="0" {{ !old('availability', $service->availability) ? 'selected' : '' }}>Busy / Waitlist</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="lg:col-span-4 space-y-8">
                        ...
                        <div class="bg-white dark:bg-slate-950 rounded-[2rem] border border-slate-100 dark:border-slate-900 p-8 shadow-sm">
                            ...
                            <div id="imagePreviewContainer"
                                ...
                                @endif
                                <div id="imagePlaceholder" class="{{ $service->image ? 'hidden' : '' }} text-center p-6">
                                    <i class="fa-solid fa-camera text-3xl text-slate-300 dark:text-slate-700 group-hover:text-primary transition-colors mb-4"></i>
                                    <p class="text-[9px] font-black text-slate-400 uppercase tracking-[0.2em]">Update Service Image</p>
                                </div>
                                <div class="absolute inset-0 bg-black/40 items-center justify-center hidden group-hover:flex">
                                    <p class="text-[9px] font-black text-white uppercase tracking-widest">Change Banner</p>
                                </div>
                            </div>
                            <input type="file"
                                   name="image"
