...
<div class="container-layout py-16">
    {{-- Protocol Header --}}
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-8 mb-16 border-b border-border dark:border-border pb-10">
        <div class="flex items-center gap-6">
            <a href="{{ route('orders.index') }}" class="h-10 w-10 bg-muted dark:bg-dark border border-border dark:border-border rounded-xl flex items-center justify-center text-muted-foreground hover:text-primary transition-all">
                <i class="fa-solid fa-chevron-left text-xs"></i>
            </a>
            <div>
                <div class="text-[10px] font-black text-muted-foreground uppercase tracking-[0.2em] mb-1">Acquisition Confirmed</div>
                <h1 class="text-3xl font-black text-foreground dark:text-white uppercase tracking-tighter">Order #{{ $order->order_number }}</h1>
            </div>
        </div>
        <div class="flex items-center gap-4">
             <span class="px-5 py-2 rounded-lg text-[9px] font-black uppercase tracking-[0.2em] bg-muted dark:bg-dark text-foreground dark:text-white border border-border dark:border-border">
            ...
            <div>
                ...
                <div class="space-y-1">
                    @foreach($order->items as $item)
                        <div class="flex items-center gap-6 p-6 hover:bg-white dark:hover:bg-dark border-b border-slate-50 dark:border-slate-900 transition-all group">
