<x-guest-layout>
    ...
    <form method="POST" action="{{ route('register', absolute: false) }}" class="space-y-6" 
        ...
        <div class="animate-fade-in" style="animation-delay: 0.2s;">
            ...
            <div class="relative group">
                <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none transition-colors text-muted-foreground"
                     :class="(touched.name && errors.name) ? 'text-warning' : (touched.name && !errors.name ? 'text-primary' : 'group-focus-within:text-primary')">
                ...
                <input id="name" type="text" name="name" x-model="formData.name" @input="validateName(true)" @blur="touched.name = true" required autofocus autocomplete="name" 
                    ...
                    :class="(touched.name && errors.name) ? 'border-warning/50 focus:ring-warning/10 focus:border-warning' : (touched.name && !errors.name ? 'border-primary/50 focus:ring-primary/10 focus:border-primary' : 'border-border focus:ring-primary/10 focus:border-primary hover:border-muted-foreground/30')"
        ...
        <div class="animate-fade-in" style="animation-delay: 0.3s;">
            ...
            <div class="relative group">
                <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none transition-colors text-muted-foreground"
                     :class="(touched.email && errors.email) ? 'text-warning' : (touched.email && !errors.email ? 'text-primary' : 'group-focus-within:text-primary')">
                ...
                <input id="email" type="email" name="email" x-model="formData.email" @input="validateEmail(true)" @blur="touched.email = true" required autocomplete="username" 
                    class="pl-11 w-full bg-input/50 backdrop-blur-sm border rounded-2xl px-4 py-3.5 text-sm text-foreground focus:ring-4 outline-none transition-all placeholder:text-muted-foreground/50 shadow-sm"
                    :class="(touched.email && errors.email) ? 'border-warning/50 focus:ring-warning/10 focus:border-warning' : (touched.email && !errors.email ? 'border-primary/50 focus:ring-primary/10 focus:border-primary' : 'border-border focus:ring-primary/10 focus:border-primary hover:border-muted-foreground/30')"
        ...
        <div class="animate-fade-in" style="animation-delay: 0.4s;">
            ...
            <div class="relative group">
                <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none transition-colors text-muted-foreground"
                     :class="(touched.password && errors.password) ? 'text-warning' : (touched.password && !errors.password ? 'text-primary' : 'group-focus-within:text-primary')">
                ...
                <input id="password" type="password" name="password" x-model="formData.password" @input="validatePassword(true)" @blur="touched.password = true" required autocomplete="new-password" 
                    class="pl-11 w-full bg-input/50 backdrop-blur-sm border rounded-2xl px-4 py-3.5 text-sm text-foreground focus:ring-4 outline-none transition-all placeholder:text-muted-foreground/50 shadow-sm"
                    :class="(touched.password && errors.password) ? 'border-warning/50 focus:ring-warning/10 focus:border-warning' : (touched.password && !errors.password ? 'border-primary/50 focus:ring-primary/10 focus:border-primary' : 'border-border focus:ring-primary/10 focus:border-primary hover:border-muted-foreground/30')"
                    placeholder="••••••••">
        ...
        <div class="animate-fade-in" style="animation-delay: 0.5s;">
            ...
            <div class="relative group">
                <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none transition-colors text-muted-foreground"
                     :class="(touched.password_confirmation && errors.password_confirmation) ? 'text-warning' : (touched.password_confirmation && !errors.password_confirmation ? 'text-primary' : 'group-focus-within:text-primary')">
                ...
                <input id="password_confirmation" type="password" name="password_confirmation" x-model="formData.password_confirmation" @input="validatePasswordConfirmation(true)" @blur="touched.password_confirmation = true" required autocomplete="new-password" 
                    class="pl-11 w-full bg-input/50 backdrop-blur-sm border rounded-2xl px-4 py-3.5 text-sm text-foreground focus:ring-4 outline-none transition-all placeholder:text-muted-foreground/50 shadow-sm"
                    :class="(touched.password_confirmation && errors.password_confirmation) ? 'border-warning/50 focus:ring-warning/10 focus:border-warning' : (touched.password_confirmation && !errors.password_confirmation ? 'border-primary/50 focus:ring-primary/10 focus:border-primary' : 'border-border focus:ring-primary/10 focus:border-primary hover:border-muted-foreground/30')"
                    placeholder="••••••••">
