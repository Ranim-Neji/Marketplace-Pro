                            ...
                            <div class="relative flex-1 bg-muted">
                                ...
                                <div class="absolute top-4 right-4 z-20" x-data="{ 
                                    ...
                                    <button @click.stop.prevent="toggle" 
                                        ...
                                        <i :class="inWishlist ? 'fa-solid text-warning drop-shadow-[0_0_8px_rgba(244,63,94,0.4)]' : 'fa-regular text-white drop-shadow-md group-hover/heart:text-warning'" class="fa-heart text-[18px] transition-all"></i>
                                    </button>
                                </div>
                            </div>
